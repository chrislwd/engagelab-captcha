...
const nav = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L12 12.75l-5.571-3m11.142 0 4.179 2.25L12 17.25l-9.75-5.25 4.179-2.25m11.142 0 4.179 2.25-9.75 5.25-9.75-5.25 4.179-2.25" />
      </svg>
    ),
  },
  {
  ...
  return (
    <aside className="flex h-screen w-64 flex-col bg-gray-900 text-white fixed left-0 top-0 z-30">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-gray-700 px-6">
        ...
        <div>
          <p className="text-sm font-bold leading-tight">EngageLab</p>
          <p className="text-xs text-gray-400">CAPTCHA</p>
        </div>
      </div>
